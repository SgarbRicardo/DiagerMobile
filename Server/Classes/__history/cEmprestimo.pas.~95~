...
begin
      ...
      begin
        erro:= 'não á emprestismo com esse numero de registro ';
        result := false;
        exit;
      end;
      ...
      begin
       ...
       if (EMPRE_LOCATARIO = '') then
      begin
        erro:= 'Erro ao encontrar usuário informado ';
        result := false;
        exit;
      end;
        ...
        begin
            try
               ...
               begin
                  ...
                  Result := false;
                  erro := 'Erro ao Inserir o Novo Equipamento para seu usuário ' + ex.Message;
               end;
             end;
        end
      finally
