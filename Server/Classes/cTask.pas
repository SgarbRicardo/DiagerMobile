...
type
    ...
    public
         ...
         function ListTaskTested(order_by: string; out erro: string): TFDQuery;
...
function TTask.ListTaskTested(order_by: string; out erro : string): TFDQuery;
var
  qry : TFDQuery;
begin
  try
      ...
      with  qry do
        begin
          ...
          if ID_ROADMAP.ToString <> '' then
          begin
            sql.Add('AND tt.roadmap_id = :roadmap_id');
            ParamByName('roadmap_id').Value := ID_ROADMAP.ToString;
          end;
    ...
    begin
        erro:= 'Erro ao carregar os testes da task selecionada: ' + ex.Message;
        Result := nil;
    end;
